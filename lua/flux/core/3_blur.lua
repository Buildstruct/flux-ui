...
function Flux.Blur.Panel(panel, size, passes, alpha)
    ...
    Flux.Blur.Noise(0, 0, panel:GetWide(), panel:GetTall(), 32 * ((alpha or 255)/255), passes, size)
end
...
function Flux.Blur.Section(x, y, w, h, size, passes, alpha)
    ...
    render.SetScissorRect(x, y, x + w, y + h, true)
        ...
        Flux.Blur.Noise(0, 0, Flux.ScrW, Flux.ScrH, 32 * ((alpha or 255)/255), passes, size)
